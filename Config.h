...
constexpr unsigned long BOOT_RESET_LONG_PRESS_MS = 1500; // BOOT長押しでJSONデータをリセット
...
constexpr uint8_t DEFAULT_BRIGHTNESS_PERCENT = 25;
constexpr uint8_t DEFAULT_MOTION_BRIGHTNESS = (DEFAULT_BRIGHTNESS_PERCENT * 255) / 100;
...
// 出身地（スマホ setting.json の hometown）。任意の文字列。
constexpr int HOMETOWN_MAX = 64;
extern char HOMETOWN[HOMETOWN_MAX];
